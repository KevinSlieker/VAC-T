...
namespace VAC_T.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,LogoURL,WebsiteURL,Adress")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,LogoURL,WebsiteURL,Adress")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
