...
namespace VAC_T.Controllers
{
    public class JobOffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Created")] JobOffer jobOffer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Created")] JobOffer jobOffer)
        {
            if (id != jobOffer.Id)
            {
                return NotFound();
