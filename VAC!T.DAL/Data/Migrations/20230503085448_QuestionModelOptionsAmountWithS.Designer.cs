...
namespace VACT.Data.Migrations
{
    ...
    [Migration("20230503085448_QuestionModelOptionsAmountWithS")]
    partial class QuestionModelOptionsAmountWithS
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOfferQuestion", b =>
                {
                    ...
                    b.HasKey("JobOffersId", "QuestionsId");
            ...
            modelBuilder.Entity("VAC_T.Models.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VAC_T.Models.QuestionOption", b =>
                {
                    ...
                    b.Property<string>("OptionLong")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OptionShort")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("JobOfferQuestion", b =>
                {
                    b.HasOne("VAC_T.Models.JobOffer", null)
                        .WithMany()
                        .HasForeignKey("JobOffersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VAC_T.Models.Question", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VAC_T.Models.Answer", b =>
                {
                    ...
                    b.HasOne("VAC_T.Models.Question", "Question")
                        .WithMany("Answers")
